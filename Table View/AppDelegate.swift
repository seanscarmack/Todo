...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func appStyles() {
        ...
        let color3 = UIColor(hue: 0/255, saturation: 0/255, brightness: 0/255, alpha: 1)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ss.Table_View" in the application's documents Application Support directory.
